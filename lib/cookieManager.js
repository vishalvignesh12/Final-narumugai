...
// Remove auto-initialization to prevent build issues
// The CookieManager should be initialized via the AutoCookieGuardian component instead
// This ensures it only runs in the proper client-side context
