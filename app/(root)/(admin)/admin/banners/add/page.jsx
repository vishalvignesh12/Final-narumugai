    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                showToast('error', response.data.message || 'Failed to create banner.')
            }
        } catch (error) {
            showToast('error', error.message || 'An error occurred while creating the banner.')
        } finally {
            setLoading(false)
        }
    }
